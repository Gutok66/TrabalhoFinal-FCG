...
Para a realização das colisões, utilizamos Axis-Aligned Bounding Box (AABB) para as colisões entre o personagem principal e as barricadas, os carros e os inimigos. Já a colisão do personagem com as paredes, o teste de intersecção feito foi o de ponto com plano, já que há um teste que garante que a posição do personagem não atravessa o limite das paredes. Os projéteis são tratados como linhas, portanto, o tratamento da colisão do projétil com as barricadas, os carros e os inimigos foram todos feitos através de testes de linha com bounding box. E o teste da colisão dos projéteis com as paredes, chão e teto do ambiente é do tipo linha com plano. 
